...
| Second beast class, per-mob spawn+dispatch (`VIRTUAL_HITBOXES.md`) | live | live | TODO | TODO |
| Second beast registration, one generic beast (`VIRTUAL_HITBOXES.md`) | live | live | TODO | TODO |
